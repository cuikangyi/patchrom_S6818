...
.field private mSwitchToPreviousSizeButton:Landroid/widget/PopupWindow;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mSwitchToPreviousSizeButton:Landroid/widget/PopupWindow;
...
.method static synthetic access$2100(Lcom/android/internal/policy/impl/PhoneWindow;)Landroid/widget/PopupWindow;
    .locals 1
    .parameter "x0"

    .prologue
    iget-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mSwitchToPreviousSizeButton:Landroid/widget/PopupWindow;

    return-object v0
.end method

.method static synthetic access$2102(Lcom/android/internal/policy/impl/PhoneWindow;Landroid/widget/PopupWindow;)Landroid/widget/PopupWindow;
    .locals 0
    .parameter "x0"
    .parameter "x1"

    .prologue
    iput-object p1, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mSwitchToPreviousSizeButton:Landroid/widget/PopupWindow;
...
.method static synthetic access$4200(Lcom/android/internal/policy/impl/PhoneWindow;)V
    .locals 0
    .parameter "x0"
...
.method private installDecor()V
    ...
    iget-object v13, v0, Lcom/android/internal/policy/impl/PhoneWindow;->mDecor:Lcom/android/internal/policy/impl/PhoneWindow$DecorView;
    ...
    iput-object v13, v0, Lcom/android/internal/policy/impl/PhoneWindow;->mDecor:Lcom/android/internal/policy/impl/PhoneWindow$DecorView;
    ...
    invoke-virtual {v13, v14}, Landroid/view/ViewGroup;->setDescendantFocusability(I)V
    ...
    invoke-virtual {v13, v14}, Landroid/view/View;->setIsRootNamespace(Z)V

    :cond_0
    move-object/from16 v0, p0

    iget-object v13, v0, Lcom/android/internal/policy/impl/PhoneWindow;->mContentParent:Landroid/view/ViewGroup;
    ...
    invoke-virtual {v0, v13}, Lcom/android/internal/policy/impl/PhoneWindow;->generateLayout(Lcom/android/internal/policy/impl/PhoneWindow$DecorView;)Landroid/view/ViewGroup;

    move-result-object v13

    move-object/from16 v0, p0

    iput-object v13, v0, Lcom/android/internal/policy/impl/PhoneWindow;->mContentParent:Landroid/view/ViewGroup;

    move-object/from16 v0, p0

    iget-object v13, v0, Lcom/android/internal/policy/impl/PhoneWindow;->mDecor:Lcom/android/internal/policy/impl/PhoneWindow$DecorView;

    invoke-virtual {v13}, Landroid/view/ViewGroup;->makeOptionalFitsSystemWindows()V
    ...
    iput-object v13, v0, Lcom/android/internal/policy/impl/PhoneWindow;->mTitleView:Landroid/widget/TextView;

    move-object/from16 v0, p0

    iget-object v13, v0, Lcom/android/internal/policy/impl/PhoneWindow;->mTitleView:Landroid/widget/TextView;
    ...
    .local v11, titleContainer:Landroid/view/View;
    if-eqz v11, :cond_6
    ...
    instance-of v13, v13, Landroid/widget/FrameLayout;
    ...
    invoke-virtual {v13, v14}, Landroid/widget/FrameLayout;->setForeground(Landroid/graphics/drawable/Drawable;)V

    .end local v11           #titleContainer:Landroid/view/View;
    :cond_1
    :goto_1
    sget-object v13, Lcom/android/internal/policy/impl/PhoneWindow;->sMultiPhoneWindowEventClass:Ljava/lang/Class;

    if-nez v13, :cond_2

    :try_start_0
    const-string v13, "com.android.internal.policy.impl.multiwindow.MultiPhoneWindowEvent"
    ...
    const-class v16, Landroid/view/Window;
    ...
    sput-object v13, Lcom/android/internal/policy/impl/PhoneWindow;->sInstallDecorMethod:Ljava/lang/reflect/Method;
    ...
    sput-object v13, Lcom/android/internal/policy/impl/PhoneWindow;->sOnConfigurationChangedMethod:Ljava/lang/reflect/Method;

    const-string v13, "onWindowStatusChanged"
    ...
    sput-object v13, Lcom/android/internal/policy/impl/PhoneWindow;->sOnWindowStatusChangedMethod:Ljava/lang/reflect/Method;

    const-string v13, "onWindowAttributesChanged"
    ...
    sput-object v13, Lcom/android/internal/policy/impl/PhoneWindow;->sOnWindowAttributesChangedMethod:Ljava/lang/reflect/Method;

    const-string v13, "onDetachedFromWindow"
    ...
    sput-object v13, Lcom/android/internal/policy/impl/PhoneWindow;->sOnDetachedFromWindow:Ljava/lang/reflect/Method;

    const-string v13, "onAttachedFromWindow"
    ...
    sput-object v13, Lcom/android/internal/policy/impl/PhoneWindow;->sOnAttachedFromWindow:Ljava/lang/reflect/Method;

    sput-object v3, Lcom/android/internal/policy/impl/PhoneWindow;->sMultiPhoneWindowEventClass:Ljava/lang/Class;
    :try_end_0
    ...
    sget-object v13, Lcom/android/internal/policy/impl/PhoneWindow;->sInstallDecorMethod:Ljava/lang/reflect/Method;
    ...
    iput-object v13, v0, Lcom/android/internal/policy/impl/PhoneWindow;->mMultiPhoneWindowEvent:Ljava/lang/Object;
    ...
    .local v5, isSupportedMultiWindow:Z
    const/4 v6, 0x0

    .local v6, isWindowNoController:Z
    move-object/from16 v0, p0

    iget-object v13, v0, Lcom/android/internal/policy/impl/PhoneWindow;->mDecor:Lcom/android/internal/policy/impl/PhoneWindow$DecorView;

    #calls: Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->getWindowMode()I
    invoke-static {v13}, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->access$3900(Lcom/android/internal/policy/impl/PhoneWindow$DecorView;)I

    move-result v12

    .local v12, windowMode:I
    invoke-static {v12}, Lcom/android/internal/policy/impl/MultiWindowReflector$Policy;->option(I)I

    move-result v13

    sget v14, Lcom/android/internal/policy/impl/MultiWindowReflector$Policy;->WINDOW_MODE_OPTION_COMMON_RESIZE:I
    ...
    sget v14, Lcom/android/internal/policy/impl/MultiWindowReflector$Policy;->WINDOW_MODE_OPTION_COMMON_NO_TITLE_BAR:I
    ...
    invoke-virtual {v13}, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->addSwitchToPreviousSizeButton()V
    :try_end_1
    ...
    .end local v5           #isSupportedMultiWindow:Z
    .end local v6           #isWindowNoController:Z
    .end local v12           #windowMode:I
    :cond_5
    :goto_3
    return-void

    .restart local v11       #titleContainer:Landroid/view/View;
    :cond_6
    move-object/from16 v0, p0
    ...
    iget-object v14, v0, Lcom/android/internal/policy/impl/PhoneWindow;->mTitle:Ljava/lang/CharSequence;
    ...
    iput-object v13, v0, Lcom/android/internal/policy/impl/PhoneWindow;->mActionBar:Lcom/android/internal/widget/ActionBarView;
    ...
    invoke-virtual {v13, v14}, Lcom/android/internal/widget/ActionBarView;->setWindowCallback(Landroid/view/Window$Callback;)V

    move-object/from16 v0, p0

    iget-object v13, v0, Lcom/android/internal/policy/impl/PhoneWindow;->mActionBar:Lcom/android/internal/widget/ActionBarView;

    invoke-virtual {v13}, Lcom/android/internal/widget/ActionBarView;->getTitle()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v13, v14}, Lcom/android/internal/widget/ActionBarView;->setWindowTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v13}, Lcom/android/internal/widget/ActionBarView;->initProgress()V
    ...
    iget v13, v0, Lcom/android/internal/policy/impl/PhoneWindow;->mUiOptions:I
    ...
    check-cast v9, Lcom/android/internal/widget/ActionBarContainer;

    .local v9, splitView:Lcom/android/internal/widget/ActionBarContainer;
    if-eqz v9, :cond_f
    ...
    invoke-virtual {v13, v9}, Lcom/android/internal/widget/AbsActionBarView;->setSplitView(Lcom/android/internal/widget/ActionBarContainer;)V

    move-object/from16 v0, p0

    iget-object v13, v0, Lcom/android/internal/policy/impl/PhoneWindow;->mActionBar:Lcom/android/internal/widget/ActionBarView;

    invoke-virtual {v13, v8}, Lcom/android/internal/widget/ActionBarView;->setSplitActionBar(Z)V

    move-object/from16 v0, p0

    iget-object v13, v0, Lcom/android/internal/policy/impl/PhoneWindow;->mActionBar:Lcom/android/internal/widget/ActionBarView;

    invoke-virtual {v13, v10}, Lcom/android/internal/widget/AbsActionBarView;->setSplitWhenNarrow(Z)V
    ...
    invoke-virtual {v2, v9}, Lcom/android/internal/widget/AbsActionBarView;->setSplitView(Lcom/android/internal/widget/ActionBarContainer;)V

    invoke-virtual {v2, v8}, Lcom/android/internal/widget/ActionBarContextView;->setSplitActionBar(Z)V

    invoke-virtual {v2, v10}, Lcom/android/internal/widget/AbsActionBarView;->setSplitWhenNarrow(Z)V
    ...
    new-instance v14, Lcom/android/internal/policy/impl/PhoneWindow$1;

    move-object/from16 v0, p0

    invoke-direct {v14, v0}, Lcom/android/internal/policy/impl/PhoneWindow$1;-><init>(Lcom/android/internal/policy/impl/PhoneWindow;)V

    invoke-virtual {v13, v14}, Landroid/view/View;->post(Ljava/lang/Runnable;)Z

    goto/16 :goto_1

    .end local v9           #splitView:Lcom/android/internal/widget/ActionBarContainer;
    .end local v10           #splitWhenNarrow:Z
    :cond_d
    const/4 v10, 0x0

    goto :goto_4

    .restart local v10       #splitWhenNarrow:Z
    :cond_e
    invoke-virtual/range {p0 .. p0}, Landroid/view/Window;->getWindowStyle()Landroid/content/res/TypedArray;
    ...
    .restart local v9       #splitView:Lcom/android/internal/widget/ActionBarContainer;
    :cond_f
    if-eqz v8, :cond_c

    const-string v13, "PhoneWindow"

    const-string v14, "Requested split action bar with incompatible window decor! Ignoring request."
...
.method protected onKeyDown(IILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v3, v2, v5}, Landroid/content/Context;->sendOrderedBroadcast(Landroid/content/Intent;Ljava/lang/String;)V
