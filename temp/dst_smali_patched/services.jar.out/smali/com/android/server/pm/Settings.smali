...
.method private getPackageLPw(Ljava/lang/String;Lcom/android/server/pm/PackageSetting;Ljava/lang/String;Lcom/android/server/pm/SharedUserSetting;Ljava/io/File;Ljava/io/File;Ljava/lang/String;IIZZ)Lcom/android/server/pm/PackageSetting;
    ...
    invoke-virtual {v3, v4, v5}, Lcom/android/server/pm/PackageSettingBase;->setStopped(ZI)V

    const/4 v4, 0x1

    iget v5, v14, Landroid/content/pm/UserInfo;->id:I

    invoke-virtual {v3, v4, v5}, Lcom/android/server/pm/PackageSettingBase;->setNotLaunched(ZI)V
    ...
    invoke-virtual {v11, v15}, Lcom/android/server/pm/PackageSettingBase;->getDisabledComponents(I)Ljava/util/HashSet;

    move-result-object v5

    invoke-direct {v4, v5}, Ljava/util/HashSet;-><init>(Ljava/util/Collection;)V

    invoke-virtual {v3, v4, v15}, Lcom/android/server/pm/PackageSettingBase;->setDisabledComponents(Ljava/util/HashSet;I)V

    new-instance v4, Ljava/util/HashSet;

    invoke-virtual {v11, v15}, Lcom/android/server/pm/PackageSettingBase;->getEnabledComponents(I)Ljava/util/HashSet;

    move-result-object v5

    invoke-direct {v4, v5}, Ljava/util/HashSet;-><init>(Ljava/util/Collection;)V

    invoke-virtual {v3, v4, v15}, Lcom/android/server/pm/PackageSettingBase;->setEnabledComponents(Ljava/util/HashSet;I)V
...
.method dumpPackagesLPr(Ljava/io/PrintWriter;Ljava/lang/String;Lcom/android/server/pm/PackageManagerService$DumpState;)V
    ...
    invoke-virtual {v8, v13}, Lcom/android/server/pm/PackageSettingBase;->getStopped(I)Z
    ...
    invoke-virtual {v8, v13}, Lcom/android/server/pm/PackageSettingBase;->getEnabled(I)I
    ...
    invoke-virtual {v8, v13}, Lcom/android/server/pm/PackageSettingBase;->getDisabledComponents(I)Ljava/util/HashSet;
    ...
    invoke-virtual {v8, v13}, Lcom/android/server/pm/PackageSettingBase;->getEnabledComponents(I)Ljava/util/HashSet;
...
.method isEnabledLPr(Landroid/content/pm/ComponentInfo;II)Z
    ...
    :cond_4
    invoke-virtual {v1, p3}, Lcom/android/server/pm/PackageSettingBase;->getEnabledComponents(I)Ljava/util/HashSet;
    ...
    invoke-virtual {v1, p3}, Lcom/android/server/pm/PackageSettingBase;->getDisabledComponents(I)Ljava/util/HashSet;
...
.method readPackageRestrictionsLPr(I)V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/server/pm/PackageSettingBase;->setStopped(ZI)V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/server/pm/PackageSettingBase;->setNotLaunched(ZI)V
    :try_end_2
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_2 .. :try_end_2} :catch_0
    ...
    invoke-virtual {v0, v7, v1}, Lcom/android/server/pm/PackageSettingBase;->setEnabled(II)V
    ...
    invoke-virtual {v0, v4, v1}, Lcom/android/server/pm/PackageSettingBase;->setEnabledComponents(Ljava/util/HashSet;I)V
    :try_end_5
    ...
    invoke-virtual {v0, v4, v1}, Lcom/android/server/pm/PackageSettingBase;->setDisabledComponents(Ljava/util/HashSet;I)V
...
.method setPackageStoppedStateLPw(Ljava/lang/String;ZZII)Z
    ...
    :cond_2
    invoke-virtual {v7, v8, p5}, Lcom/android/server/pm/PackageSettingBase;->setNotLaunched(ZI)V
...
.method writePackageRestrictionsLPr(I)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/pm/PackageSettingBase;->getStopped(I)Z
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/pm/PackageSettingBase;->getNotLaunched(I)Z
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/pm/PackageSettingBase;->getEnabled(I)I
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/pm/PackageSettingBase;->getEnabledComponents(I)Ljava/util/HashSet;
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/pm/PackageSettingBase;->getDisabledComponents(I)Ljava/util/HashSet;
