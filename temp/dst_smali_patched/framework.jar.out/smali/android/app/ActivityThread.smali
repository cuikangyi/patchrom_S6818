...
.method private handleDestroyActivity(Landroid/os/IBinder;ZIZ)V
    ...
    invoke-virtual {v6, v5, v7, v8}, Landroid/view/WindowManagerImpl;->closeAll(Landroid/os/IBinder;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v6, p1, v7, v8}, Landroid/view/WindowManagerImpl;->closeAll(Landroid/os/IBinder;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v7, "Remove view failed when handle destroy activity!"
...
.method private performLaunchActivity(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/content/Intent;)Landroid/app/Activity;
    ...
    iget-boolean v3, v0, Landroid/app/ActivityThread;->mSystemThread:Z
    ...
    iget-object v3, v0, Landroid/app/ActivityThread;->mH:Landroid/app/ActivityThread$H;

    const/16 v4, 0x64

    move-object/from16 v0, p1

    invoke-virtual {v3, v4, v0}, Landroid/app/ActivityThread$H;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-virtual {v3, v0, v4, v5}, Landroid/app/ActivityThread$H;->sendMessageDelayed(Landroid/os/Message;J)Z

    const-string v3, "ActivityThread"

    const-string v4, "mCompatConfiguration is null while performLaunchActivity, so try again after 30ms."

    invoke-static {v3, v4}, Landroid/util/Log;->v(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_1
    .catch Landroid/app/SuperNotCalledException; {:try_start_1 .. :try_end_1} :catch_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_2
    ...
    throw v3
    :try_end_2
    .catch Landroid/app/SuperNotCalledException; {:try_start_2 .. :try_end_2} :catch_1
    .catch Ljava/lang/Exception; {:try_start_2 .. :try_end_2} :catch_2
    ...
    throw v3
    :try_end_3
    .catch Landroid/app/SuperNotCalledException; {:try_start_3 .. :try_end_3} :catch_1
    ...
    :try_end_4
    .catch Landroid/app/SuperNotCalledException; {:try_start_4 .. :try_end_4} :catch_1
...
.method final handleConfigurationChanged(Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)V
    ...
    invoke-virtual {v9, p1}, Landroid/content/res/Configuration;->diff(Landroid/content/res/Configuration;)I
    ...
    invoke-virtual {p0, v9, p1}, Landroid/app/ActivityThread;->collectComponentCallbacksLocked(ZLandroid/content/res/Configuration;)Ljava/util/ArrayList;
    ...
    iget-object v9, v7, Landroid/app/ActivityThread$ProviderClientRecord;->mLocalProvider:Landroid/content/ContentProvider;
    ...
    invoke-virtual {v9}, Landroid/view/WindowManagerImpl;->trimLocalMemory()V
    ...
    invoke-static {v9, p1}, Landroid/app/ActivityThread;->performConfigurationChanged(Landroid/content/ComponentCallbacks2;Landroid/content/res/Configuration;)V
    ...
    .end local v1           #activity:Landroid/app/Activity;
    .end local v8           #shouldChangeConfig:Z
    ...
    .end local v3           #cb:Landroid/content/ComponentCallbacks2;
    .restart local v1       #activity:Landroid/app/Activity;
    .restart local v8       #shouldChangeConfig:Z
    :cond_a
