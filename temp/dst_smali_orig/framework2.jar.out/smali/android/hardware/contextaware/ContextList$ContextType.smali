...
.field public static final enum AGGREGATOR_HUMIDITY:Landroid/hardware/contextaware/ContextList$ContextType;
...
.field public static final enum AGGREGATOR_TEMPERATURE:Landroid/hardware/contextaware/ContextList$ContextType;
...
.field public static final enum SENSORHUB_PARSER_NOTI_POWER:Landroid/hardware/contextaware/ContextList$ContextType;

.field public static final enum SENSORHUB_RUNNER_ACTIGRAPH:Landroid/hardware/contextaware/ContextList$ContextType;
...
.field public static final enum SENSORHUB_RUNNER_RAW_HUMIDITY_SENSOR:Landroid/hardware/contextaware/ContextList$ContextType;

.field public static final enum SENSORHUB_RUNNER_RAW_TEMPERATURE_SENSOR:Landroid/hardware/contextaware/ContextList$ContextType;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/hardware/contextaware/ContextList$ContextType;->AGGREGATOR_TEMPERATURE:Landroid/hardware/contextaware/ContextList$ContextType;

    new-instance v0, Landroid/hardware/contextaware/ContextList$ContextType;

    const-string v1, "AGGREGATOR_HUMIDITY"
    ...
    sput-object v0, Landroid/hardware/contextaware/ContextList$ContextType;->AGGREGATOR_HUMIDITY:Landroid/hardware/contextaware/ContextList$ContextType;
    ...
    const-string v1, "SENSORHUB_RUNNER_RAW_TEMPERATURE_SENSOR"

    const/16 v2, 0x17

    const-string v3, "RAW_TEMPERATURE_SENSOR"

    invoke-direct {v0, v1, v2, v3}, Landroid/hardware/contextaware/ContextList$ContextType;-><init>(Ljava/lang/String;ILjava/lang/String;)V

    sput-object v0, Landroid/hardware/contextaware/ContextList$ContextType;->SENSORHUB_RUNNER_RAW_TEMPERATURE_SENSOR:Landroid/hardware/contextaware/ContextList$ContextType;

    new-instance v0, Landroid/hardware/contextaware/ContextList$ContextType;

    const-string v1, "SENSORHUB_RUNNER_RAW_HUMIDITY_SENSOR"

    const/16 v2, 0x18

    const-string v3, "RAW_HUMIDITY_SENSOR"

    invoke-direct {v0, v1, v2, v3}, Landroid/hardware/contextaware/ContextList$ContextType;-><init>(Ljava/lang/String;ILjava/lang/String;)V

    sput-object v0, Landroid/hardware/contextaware/ContextList$ContextType;->SENSORHUB_RUNNER_RAW_HUMIDITY_SENSOR:Landroid/hardware/contextaware/ContextList$ContextType;
    ...
    const-string v1, "SENSORHUB_RUNNER_ACTIGRAPH"

    const/16 v2, 0x1a

    const-string v3, "ACTIGRAPH"

    invoke-direct {v0, v1, v2, v3}, Landroid/hardware/contextaware/ContextList$ContextType;-><init>(Ljava/lang/String;ILjava/lang/String;)V

    sput-object v0, Landroid/hardware/contextaware/ContextList$ContextType;->SENSORHUB_RUNNER_ACTIGRAPH:Landroid/hardware/contextaware/ContextList$ContextType;
    ...
    sput-object v0, Landroid/hardware/contextaware/ContextList$ContextType;->SENSORHUB_PARSER_NOTI_POWER:Landroid/hardware/contextaware/ContextList$ContextType;
    ...
    sget-object v1, Landroid/hardware/contextaware/ContextList$ContextType;->AGGREGATOR_TEMPERATURE:Landroid/hardware/contextaware/ContextList$ContextType;

    aput-object v1, v0, v7

    sget-object v1, Landroid/hardware/contextaware/ContextList$ContextType;->AGGREGATOR_HUMIDITY:Landroid/hardware/contextaware/ContextList$ContextType;
    ...
    sget-object v2, Landroid/hardware/contextaware/ContextList$ContextType;->SENSORHUB_RUNNER_RAW_TEMPERATURE_SENSOR:Landroid/hardware/contextaware/ContextList$ContextType;

    aput-object v2, v0, v1

    const/16 v1, 0x18

    sget-object v2, Landroid/hardware/contextaware/ContextList$ContextType;->SENSORHUB_RUNNER_RAW_HUMIDITY_SENSOR:Landroid/hardware/contextaware/ContextList$ContextType;
    ...
    sget-object v2, Landroid/hardware/contextaware/ContextList$ContextType;->SENSORHUB_RUNNER_ACTIGRAPH:Landroid/hardware/contextaware/ContextList$ContextType;
