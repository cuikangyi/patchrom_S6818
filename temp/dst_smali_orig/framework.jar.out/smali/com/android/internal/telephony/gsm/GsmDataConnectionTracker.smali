...
.method public constructor <init>(Lcom/android/internal/telephony/PhoneBase;)V
    ...
    const-string v1, "persist.radio.use_nv_for_ehrpd"
...
.method private onDataStateChanged(Landroid/os/AsyncResult;)V
    ...
    const-string v20, "onDataStateChanged(): apnsToCleanup is null"
...
.method private preProcessDataConnection(Ljava/lang/String;)Z
    ...
    const-string v6, "storedDataconntionReason:"
...
.method private reconnectAfterFail(Lcom/android/internal/telephony/DataConnection$FailCause;Lcom/android/internal/telephony/ApnContext;I)V
    ...
    const-string v2, "reconnectAfterFail: KT pdp rety just 3 times retyCount is "
...
.method private setupData(Lcom/android/internal/telephony/ApnContext;)Z
    ...
    const-string v6, "setupData: No ready GsmDataConnection found!"
    ...
    const-string v6, "setupData: reset dc before recycle"
    ...
    const-string v6, "setupData: No free GsmDataConnection found!"
    ...
    const-string v7, "setupData: init dc and apnContext refCount="
...
.method private trySetupData(Lcom/android/internal/telephony/ApnContext;)Z
    ...
    const-string v8, "ril.domesticOta"
    ...
    invoke-direct {p0, v8}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->isDataAllowedOnDataDisabled(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v8}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->buildWaitingApns(Ljava/lang/String;)Ljava/util/ArrayList;

    move-result-object v7

    .local v7, waitingApns:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/ApnSetting;>;"
    ...
    :cond_4
    invoke-virtual {p1, v7}, Lcom/android/internal/telephony/ApnContext;->setWaitingApns(Ljava/util/ArrayList;)V

    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string v9, "trySetupData: Create from mAllApns : "
    ...
    invoke-direct {p0, v9}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->apnListToString(Ljava/util/ArrayList;)Ljava/lang/String;
    ...
    .end local v7           #waitingApns:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/ApnSetting;>;"
    :cond_5
    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string v9, "Setup watingApns : "
    ...
    const-string v0, "settings_hedge_data_call_block"
    ...
    const-string v9, "settings_hedge_data_call_block"
    ...
    const-string v8, "LTE Test mode - 2G/3G Data Call Block on"
    ...
    const-string v9, "current RAT is "
    ...
    const-string v9, ". ignore trySetupData()!!!"
...
.method private updateDataActivity()V
    ...
    const-string v3, "updateDataActivity: mApnContexts is null"
    ...
    const-string v3, "updateDataActivity: apnContext is null"
...
.method protected onActionIntentReconnectAlarm(Landroid/content/Intent;)V
    ...
    const-string v7, "onActionIntentReconnectAlarm: reason="
    ...
    const-string v7, "onActionIntentReconnectAlarm: ignore apnConext:"
    ...
    const-string v7, "onActionIntentReconnectAlarm: ignore - dcac "
...
.method protected onDataStallAlarm(I)V
    ...
    const-string v6, "onDataStallAlarm: ignore, tag="
    ...
    const-string v6, "pdp_watchdog_trigger_packet_count"
    ...
    const-string v6, "onDataStallAlarm: tag="
    ...
    const-string v6, "onDataStallAlarm: 2G skip alarm Count="
...
.method protected onMobileDataDbChanged()V
    ...
    const-string v2, "onDataConnectionDbChanged: Shouldn\'t set preferred mode in Roaming area "
    ...
    const-string v2, "onDataConnectionDbChanged > NETWORK_MODE_GSM_WCDMA_LTE"
    ...
    const-string v3, "onDataConnectionDbChanged: Shouldn\'t set preferred mode because LTE mode is "
    ...
    const-string v2, "onDataConnectionDbChanged > NETWORK_MODE_GSM_UMTS"
...
.method protected onScreenStateChanged(Z)V
    ...
    :cond_1
    const-string v5, "onScreenStateChanged: reset retry count in default dc."
    ...
    const-string v5, "onScreenStateChanged: retry connect"
