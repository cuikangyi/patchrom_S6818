...
.method draw(Landroid/view/View;Landroid/view/View$AttachInfo;Landroid/view/HardwareRenderer$HardwareDrawCallbacks;Landroid/graphics/Rect;)Z
    ...
    invoke-static/range {v19 .. v19}, Landroid/view/HardwareRenderer;->access$200([I)V
    ...
    .line 1131
    .local v10, getDisplayListStartTime:J
    move-object/from16 v0, p0
    ...
    const-string v21, "getDisplayList"
    ...
    const-string v21, "drawDisplayList"
    ...
    invoke-direct {v0, v1, v2}, Landroid/view/HardwareRenderer$GlRenderer;->handleFunctorStatus(Landroid/view/View$AttachInfo;I)V
    :try_end_4
    ...
    .line 1186
    invoke-virtual {v3, v14}, Landroid/graphics/Canvas;->restoreToCount(I)V
    ...
    .line 1209
    .local v8, eglSwapBuffersStartTime:J
    move-object/from16 v0, p0
    ...
    .line 1213
    :cond_a
    sget-object v19, Landroid/view/HardwareRenderer$GlRenderer;->sEgl:Ljavax/microedition/khronos/egl/EGL10;

    sget-object v20, Landroid/view/HardwareRenderer$GlRenderer;->sEglDisplay:Ljavax/microedition/khronos/egl/EGLDisplay;
    ...
    invoke-interface/range {v19 .. v21}, Ljavax/microedition/khronos/egl/EGL10;->eglSwapBuffers(Ljavax/microedition/khronos/egl/EGLDisplay;Ljavax/microedition/khronos/egl/EGLSurface;)Z
    ...
    .line 1224
    .end local v8           #eglSwapBuffersStartTime:J
    :cond_c
    move-object/from16 v0, p0
    ...
    .end local v10           #getDisplayListStartTime:J
    .end local v14           #saveCount:I
    .end local v16           #status:I
    .end local v17           #surfaceState:I
    :cond_e
    :goto_3
    return v19
    ...
    .restart local v17       #surfaceState:I
    :cond_f
    move-object/from16 v0, p0

    iget-object v15, v0, Landroid/view/HardwareRenderer$GlRenderer;->mSurfaceSize:[I

    .line 1109
    .local v15, size:[I
    #calls: Landroid/view/HardwareRenderer;->beginFrame([I)V
    invoke-static {v15}, Landroid/view/HardwareRenderer;->access$200([I)V
    ...
    .line 1146
    .restart local v10       #getDisplayListStartTime:J
    :catchall_0
    move-exception v19
    ...
    :try_start_6
    const-string v19, "HardwareRenderer"

    new-instance v20, Ljava/lang/StringBuilder;

    invoke-direct/range {v20 .. v20}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v21, "view can\'t draw "
