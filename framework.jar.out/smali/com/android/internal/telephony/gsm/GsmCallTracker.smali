...
.method checkEmergencyCallRedirectToNormalCall()Z
    ...
    const-string/jumbo v6, "no redirect mcc:"
    ...
    invoke-virtual {v6}, Lcom/android/internal/telephony/gsm/GSMPhone;->getIccCard()Lcom/android/internal/telephony/IccCard;
    ...
    .line 1264
    const-string/jumbo v4, "redirect ecc to normal because here is china"
    ...
    .line 1276
    const-string/jumbo v4, "redirect ecc to normal because here is taiwan"
    ...
    .line 1280
    :cond_7
    const-string/jumbo v5, "no redirection"
...
.method declared-synchronized dial(Ljava/lang/String;ILcom/android/internal/telephony/UUSInfo;Lcom/android/internal/telephony/Call$CallType;)Lcom/android/internal/telephony/Connection;
    ...
    invoke-virtual {v0, p4}, Lcom/android/internal/telephony/Call;->setCallType(Lcom/android/internal/telephony/Call$CallType;)V
...
.method dialVideoCall(Ljava/lang/String;ILcom/android/internal/telephony/Call$CallType;)Lcom/android/internal/telephony/Connection;
    ...
    invoke-virtual {v0, p3}, Lcom/android/internal/telephony/Call;->setCallType(Lcom/android/internal/telephony/Call$CallType;)V
...
.method protected declared-synchronized handlePollCalls(Landroid/os/AsyncResult;)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/internal/telephony/CallTracker;->isCommandExceptionRadioNotAvailable(Ljava/lang/Throwable;)Z
    ...
    invoke-virtual {v0, v2}, Lcom/android/internal/telephony/CallTracker;->addNumberOfCalls(Z)V
    ...
    invoke-virtual {v0, v3}, Lcom/android/internal/telephony/CallTracker;->obtainNoPollCompleteMessage(I)Landroid/os/Message;
